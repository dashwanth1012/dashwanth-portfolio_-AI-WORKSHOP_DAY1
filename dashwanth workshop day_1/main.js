...
console.log('%c✨ Dashwanth Portfolio ✨', 'color: #38BDF8; font-size: 16px; font-weight: bold;');
console.log('%c📍 CSS and JS successfully loaded', 'color: #94A3B8; font-size: 12px;');